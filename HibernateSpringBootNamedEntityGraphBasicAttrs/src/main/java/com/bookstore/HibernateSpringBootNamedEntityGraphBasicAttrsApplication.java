...
public class HibernateSpringBootNamedEntityGraphBasicAttrsApplication {

    @Autowired
    private BookstoreService bookstoreService;

    public static void main(String[] args) {
        SpringApplication.run(HibernateSpringBootNamedEntityGraphBasicAttrsApplication.class, args);
    }
